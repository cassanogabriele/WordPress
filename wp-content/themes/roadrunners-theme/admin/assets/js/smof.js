...
jQuery(document).ready(function($){
	...
	$('#expand_options').click(function(){
		if(flip == 0){
			...
			$('#of_container #content').width(880);
			...
			$('#of_container #content').width(680);
	...
	// event.preventDefault();
	var agree = confirm("Are you sure you wish to delete this element?");
		if (agree) {
	...
	$(".slide_add_button").live('click', function(){		
		...
		'<li class="temphide">' + 
			...
			'<div class="slide_body" style="display: none; ">' +
				...
				'<input class="upload slide of-input" name="' + sliderId + '[' + newNum + '][url]" id="' + sliderId + '_' + newNum + '_slide_url" value="">' + 
				
				'<div class="upload_button_div">' + 
					'<span class="button media_upload_button" id="' + sliderId + '_' + newNum + '">Upload</span>' + 
					'<span class="button remove-image hide" id="reset_' + sliderId + '_' + newNum + '" title="' + sliderId + '_' + newNum + '">Remove</span>' + 
				'</div>' + 
